...
describe("SF-N03 FLUJO 03 class operations", () => {
  const migrationPath = "supabase/migrations/20260919170258_flow03_class_operations.sql";
  ...
  it("keeps active-class walk-in eligibility capability-scoped", () => {
    const activeEligibility = source(
      "supabase/migrations/20260919170310_flow03_admin_walkin_eligibility.sql",
    );
