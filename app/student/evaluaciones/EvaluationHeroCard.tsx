...
export default function EvaluationHeroCard({
  ...
  return (
    <section className="relative overflow-hidden rounded-[28px] border border-fuchsia-500/35 bg-[linear-gradient(135deg,#250919_0%,#140813_42%,#090d13_100%)] shadow-[0_0_34px_rgba(236,72,153,0.10)]">
      ...
      <div className="pointer-events-none absolute right-2 top-3 h-[190px] w-[145px] opacity-75 sm:right-10 sm:top-4 sm:h-[210px] sm:w-[165px]" aria-hidden="true">
        <svg viewBox="0 0 165 210" className="h-full w-full overflow-visible">
          ...
          <line x1="128" y1="-8" x2="128" y2="220" stroke="rgba(244,114,182,0.68)" strokeWidth="2" filter="url(#evalGlow)" />
          <circle cx="88" cy="48" r="13" fill="rgba(244,114,182,0.18)" stroke="rgba(244,114,182,0.48)" strokeWidth="1.5" />
          <path d="M82 61 C72 82, 76 108, 91 125 C103 138, 109 155, 107 182 C92 171, 82 158, 76 145 C68 127, 55 115, 43 103 C60 96, 69 89, 74 74 Z" fill="url(#evalBodyGlow)" stroke="rgba(244,114,182,0.42)" strokeWidth="1.4" />
          <path d="M94 66 C108 62, 117 47, 125 28" fill="none" stroke="rgba(244,114,182,0.55)" strokeWidth="5" strokeLinecap="round" />
          <path d="M87 75 C100 83, 113 89, 127 92" fill="none" stroke="rgba(244,114,182,0.35)" strokeWidth="4" strokeLinecap="round" />
          <path d="M77 132 C61 148, 48 165, 36 191" fill="none" stroke="rgba(244,114,182,0.32)" strokeWidth="6" strokeLinecap="round" />
          <path d="M101 127 C115 145, 124 163, 130 190" fill="none" stroke="rgba(244,114,182,0.34)" strokeWidth="6" strokeLinecap="round" />
          <path d="M74 52 C65 45, 63 34, 69 26 C70 38, 77 41, 88 41" fill="none" stroke="rgba(244,114,182,0.35)" strokeWidth="2" strokeLinecap="round" />
        </svg>
      </div>
