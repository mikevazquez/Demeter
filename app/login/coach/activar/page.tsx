...
import { completeCoachPasswordActivation } from "./actions";
...
export default async function CoachActivationPage({
  searchParams,
}: {
  ...
  return (
    <main className="auth-shell">
      <section className="auth-card">
        ...
        <form action={completeCoachPasswordActivation} className="auth-form">
          <label>
            Nueva contraseña
            <input
              name="password"
