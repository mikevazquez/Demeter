-- FLUJO 02 · alineación con decisión aprobada del 18/09/2026
-- INACTIVAR conserva reservas futuras. ELIMINAR sí las cancela.
-- La eliminación también desvincula user_id histórico sin destruir transacciones.
